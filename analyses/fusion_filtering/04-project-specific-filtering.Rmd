...
params:
  histology:
    label: "Clinical file" 
    value: data/release_003_008/pbta-histologies.tsv
    input: file
  group:
  ...
  dataStranded:
    ...
    value: analyses/fusion_filtering/scratch/standardFusionStrandedExp_QC_expression_GTExComparison_annotated.RDS
    input: file
  dataPolya:
    label: "Input filtered fusion dataframe"
    value: analyses/fusion_filtering/scratch/standardFusionPolyaExp_QC_expression_GTExComparison_annotated.RDS
    input: file    
  numCaller:
...
write.table(putative_driver_fusions,file.path(root_dir,"analyses","fusion_filtering","scratch","pbta-fusion-putative-oncogenic-preQC.tsv"),sep="\t",quote=FALSE,row.names = FALSE)
